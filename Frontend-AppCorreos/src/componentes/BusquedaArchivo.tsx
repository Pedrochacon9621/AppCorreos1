      ...
      const crearFormData = (event: FormEvent<HTMLFormElement>)=>{
        ...
        return (
          <div  style={{marginTop:"30px"}}>
            ...
            <p>⚠️ Importante: Algunos correos pueden llegar a la carpeta de spam o promociones.</p>
            <p>Para asegurarte de recibirlos correctamente, marca el remitente como seguro en tu bandeja de entrada.</p>
